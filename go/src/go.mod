module tyk/custom-go-plugin

go 1.17

replace github.com/hashicorp/terraform v1.0.1 => github.com/hashicorp/terraform v0.14.11

require github.com/TykTechnologies/tyk v1.9.2-0.20221107214713-5d89b79b6c18
...
require (
	...
	github.com/TykTechnologies/graphql-go-tools v1.6.2-0.20220927090058-2b5b6a6747d5 // indirect
